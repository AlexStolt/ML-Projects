...
path = 'LinearRegression/auto-mpg.data'
...
# Plot
# sns.pairplot(train_dataset[['MPG', 'Cylinders', 'Horsepower', 'Displacement', 'Weight']], diag_kind='kde')
# plt.show()
...
# Predict MPG based on horsepower
horsepower = np.array(train_features['Horsepower'])
horsepower_normalizer = tf.keras.layers.Normalization(input_shape=[1,], axis=None)
horsepower_normalizer.adapt(horsepower)
print(horsepower, horsepower_normalizer)
